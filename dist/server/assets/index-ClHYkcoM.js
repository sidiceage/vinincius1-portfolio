import { Q as reactExports, I as jsxRuntimeExports } from "./server-BeFv9Jac.js";
...
const VF_PATH = "M40 40 L160 340 L280 40 M340 340 L340 40 L520 40 M340 190 L500 190";
function LoadingScreen({ onDone }) {
  ...
  const pct = Math.round(progress2);
  const dash = 1 - progress2 / 100;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: !hidden && /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 1 },
      exit: { opacity: 0 },
      ...
      children: [
          ...
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "vfgrad", x1: "0", y1: "0", x2: "1", y2: "1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.85 0.18 200)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "50%", stopColor: "oklch(0.7 0.22 240)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.7 0.22 300)" })
                ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 font-display text-5xl font-bold text-gradient tabular-nums", children: [
          pct,
          "%"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-xs uppercase tracking-[0.4em] text-muted-foreground", children: "Initializing Experience" })
      ]
    }
  ) });
}
    ...
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto flex max-w-7xl items-center justify-between px-6 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#home", className: "flex items-center gap-2 font-display font-bold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 place-items-center rounded-lg bg-gradient-brand text-background shadow-neon", children: "VF" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-sm tracking-wide text-foreground/90", children: "Vinicius Fernandes" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex items-center gap-1 sm:gap-2", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: `#${l.id}`,
            className: `relative px-3 py-2 text-sm transition-colors ${active === l.id ? "text-foreground" : "text-muted-foreground hover:text-foreground"}`,
            children: [
              l.label,
              active === l.id && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-x-3 -bottom-0.5 h-[2px] rounded bg-gradient-brand" })
            ]
          }
        ) }, l.id)) })
      ] })
...
const vfLogo = "/assets/vf-logo-oXxGzlhX.webp";
const variants = {
  fade: {
...
function HomeSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "home", className: "relative min-h-screen overflow-hidden pt-28", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute -left-40 top-20 h-96 w-96 rounded-full bg-[oklch(0.7_0.22_240)]/30 blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute -right-32 bottom-10 h-96 w-96 rounded-full bg-[oklch(0.7_0.22_300)]/25 blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl items-center gap-10 px-6 pb-24 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-7", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "slide", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center rounded-full border border-[oklch(0.7_0.22_240)]/40 bg-[oklch(0.7_0.22_240)]/10 px-4 py-1.5 text-xs uppercase tracking-[0.25em] text-[oklch(0.85_0.18_200)]", children: "5+ Years · AI Integration Specialist" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "fade", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl font-bold leading-[1.05] sm:text-6xl lg:text-7xl", children: [
          "Hi, I'm ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Vinicius Fernandes" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "fade", delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl text-foreground/85", children: [
          "I am a",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[oklch(0.85_0.18_200)]", children: "Full-Stack Developer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 inline-block w-[2px] h-6 align-middle bg-[oklch(0.85_0.18_200)] animate-pulse" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "fade", delay: 0.3, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-xl text-base leading-relaxed text-muted-foreground", children: "Crafting fast, scalable, AI-powered web products. I help businesses ship modern applications with intelligent features that improve automation, engagement, and user experience." }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "fade", delay: 0.45, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "#projects",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "diamond", delay: 0.2, className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-[320px] w-[320px] sm:h-[440px] sm:w-[440px] rounded-full bg-white shadow-glow animate-pulse-glow overflow-hidden ring-4 ring-[oklch(0.85_0.18_200)]/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: vfLogo,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full ring-1 ring-[oklch(0.85_0.18_200)]/40 animate-spin-slow", style: { boxShadow: "0 0 60px oklch(0.85 0.18 200 / 0.4)" } })
      ] }) })
    ] })
  ] });
}
...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "relative py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { effect: "fade", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-center font-display text-5xl font-bold", children: [
        "About ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Me" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-3 h-1 w-24 rounded bg-gradient-brand" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-2xl text-center text-muted-foreground", children: "Get to know my background, what I build, and how I help teams ship modern AI-powered products." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 grid items-center gap-10 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "spinner", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-3xl glass p-8 shadow-neon", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-px rounded-3xl bg-gradient-brand opacity-20 blur-xl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: vfLogo, alt: "VF", className: "relative mx-auto w-full max-w-md" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "thread", className: "origin-left", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display text-2xl font-bold sm:text-3xl", children: [
          "Full-Stack Developer",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "| AI Integration Specialist" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "fade", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-relaxed text-foreground/85", children: "Need a fast, modern website with smart AI features? I'm a Full-Stack Developer specializing in modern web applications and AI integration. I help businesses build fast, scalable, and user-friendly products with intelligent features that improve automation, engagement, and the overall user experience." }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "fade", delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-relaxed text-muted-foreground", children: "With 5+ years of web development experience and 3+ years working with AI-powered solutions, I build everything from responsive websites to intelligent platforms powered by ChatGPT, automation systems, recommendation engines, and custom APIs." }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2 pt-2", children: highlights.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "diamond", delay: i * 0.08, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 rounded-xl border border-border bg-card/50 px-4 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 place-items-center rounded-lg bg-gradient-brand text-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx(h.icon, { className: "h-4 w-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground/90", children: h.label })
        ] }) }, h.label)) })
      ] })
    ] })
  ] }) });
...
function Bar({ value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-full overflow-hidden rounded-full bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      initial: { width: 0 },
...
function SkillsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "relative py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { effect: "fade", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-center font-display text-5xl font-bold", children: [
        "My ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-3 h-1 w-24 rounded bg-gradient-brand" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-2xl text-center text-muted-foreground", children: "A comprehensive overview of my technical expertise and proficiency across modern web stacks and AI tooling." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-6 md:grid-cols-2", children: groups.map((g, gi) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: gi % 2 === 0 ? "slide" : "diamond", delay: gi * 0.08, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl glass p-7 transition-transform hover:-translate-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-11 w-11 place-items-center rounded-xl bg-gradient-brand text-background shadow-neon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(g.icon, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold", children: g.title })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4", children: g.skills.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-1.5 flex justify-between text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[oklch(0.85_0.18_200)] tabular-nums", children: [
            s.level,
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { value: s.level })
      ] }, s.name)) })
    ] }) }, g.title)) })
  ] }) });
}
const chatbotImg = "/assets/project-chatbot-Dnae1Ki3.png";
const ecommerceImg = "/assets/project-ecommerce-CsqjOt2A.png";
const img3 = "/assets/project-3-GI29jCr2.png";
const img4 = "/assets/project-4-VYC8ApZa.png";
const img5 = "/assets/project-5-C1Eaeb1W.png";
const img6 = "/assets/project-6-D2uKncgT.png";
const categories = ["All", "Web Apps", "AI"];
const projects = [
  {
...
function ProjectsSection() {
  ...
  const list = projects.filter((p) => filter2 === "All" || p.cat === filter2);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "relative py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { effect: "fade", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-center font-display text-5xl font-bold", children: [
        "My ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-3 h-1 w-24 rounded bg-gradient-brand" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-2xl text-center text-muted-foreground", children: "A selection of recent work — full-stack web apps, AI integrations, and APIs." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "thread", className: "origin-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 flex flex-wrap justify-center gap-3", children: categories.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setFilter(c),
        className: `rounded-full border px-5 py-2 text-sm transition-all ${filter2 === c ? "border-transparent bg-gradient-brand text-background shadow-neon" : "border-border text-muted-foreground hover:text-foreground"}`,
        children: c
      },
      c
    )) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { layout: true, className: "mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "popLayout", children: list.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.a,
      {
        href: p.url || "#",
        target: p.url ? "_blank" : void 0,
        rel: p.url ? "noopener noreferrer" : void 0,
        layout: true,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative h-44 overflow-hidden bg-gradient-to-br ${p.hue}`, children: [
            p.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, alt: p.title, className: "absolute inset-0 h-full w-full object-cover object-top transition-transform duration-500 group-hover:scale-105" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-30", style: { backgroundImage: "radial-gradient(circle at 30% 30%, white 1px, transparent 1px)", backgroundSize: "18px 18px" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-3 top-3 rounded-full bg-black/50 px-3 py-1 text-xs uppercase tracking-widest text-white backdrop-blur", children: p.cat })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold", children: p.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-5 w-5 text-muted-foreground transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-foreground" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm leading-relaxed text-muted-foreground", children: p.desc }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex flex-wrap gap-2", children: p.tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-md border border-border bg-secondary/50 px-2 py-1 text-xs text-foreground/80", children: t }, t)) })
          ] })
        ]
      },
      p.title
...
function ConnectSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "connect", className: "relative py-28", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { effect: "fade", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-3 h-1 w-24 rounded bg-gradient-brand" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-2xl text-center text-muted-foreground", children: "Have a project in mind or want to discuss potential opportunities? Feel free to reach out through any of the channels below." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-14 grid gap-8 lg:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { effect: "slide", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold", children: "Contact Information" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-muted-foreground", children: "I'm always open to discussing new projects, creative ideas, or opportunities to be part of your vision." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 pt-4", children: channels.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "diamond", delay: i * 0.08, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: c.href,
              className: "flex items-center gap-4 rounded-xl glass px-5 py-4 transition-all hover:-translate-y-0.5 hover:shadow-neon",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-11 w-11 place-items-center rounded-lg bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: `h-5 w-5 ${c.color}` }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-sm font-semibold ${c.color}`, children: c.label }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { effect: "spinner", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            onSubmit: (e) => {
              e.preventDefault();
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold", children: "Send Me a Message" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid gap-4 sm:grid-cols-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Your Name", placeholder: "John Doe" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Your Email", placeholder: "john@example.com", type: "email" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1.5 block text-sm font-medium", children: "Message" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "textarea",
                  {
                    rows: 5,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-20 border-t border-border py-6 text-center text-xs text-muted-foreground", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Vinicius Fernandes - Crafted with care."
    ] })
  ] });
}
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    !ready && /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingScreen, { onDone: () => setReady(true) }),
    ready && /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectSection, {})
    ] })
  ] });
}
export {
